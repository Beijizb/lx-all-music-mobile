declare namespace LX {
  namespace Music {
    ...
    interface MusicInfoMeta_bi extends MusicInfoMeta_online {
      bvid?: string
      aid?: string
      cid?: string
      page?: number
    ...
    type MusicInfoOnline = MusicInfo_online_common | MusicInfo_kg | MusicInfo_tx | MusicInfo_mg | MusicInfo_bi
